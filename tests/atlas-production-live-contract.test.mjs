...
test('Supabase migration history stays ordered with reviewed local additions', () => {
  ...
  assert.deepEqual(migrations, [
    ...
    '20260918113236_professional_knowledge_corpus_v3.sql',
    ...
    // Reviewed repository migrations. Applied Supabase history must match these exact versions.
    ...
    '20260922084120_case_entity_lookup.sql',
